...
const CompassBackground = () => {
    return (
        <svg width='210' height='210' viewBox="0 0 210 210" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.compass}>
            <path d="M18.8711 20.249C18.8713 19.7776 19.2531 19.3957 19.7246 19.3955L104.604 19.3955L104.604 105.128L18.8711 105.128L18.8711 20.249Z" fill="#FA6661" stroke="#E06C68" strokeWidth="0.8"/>
            <path d="M105.402 19.3955L190.281 19.3955C190.753 19.3958 191.135 19.7776 191.135 20.249L191.135 105.128L105.402 105.128L105.402 19.3955Z" fill="#8DBEFF" stroke="#90B4E4" strokeWidth="0.8"/>
            <path d="M105.402 105.928L191.135 105.928L191.135 190.807C191.135 191.279 190.753 191.66 190.281 191.661L105.402 191.661L105.402 105.928Z" fill="#BE8EC8" stroke="#B884B1" strokeWidth="0.8"/>
            <path d="M18.8711 190.807L18.8711 105.928L104.604 105.928L104.604 191.661L19.7246 191.661C19.2531 191.66 18.8713 191.279 18.8711 190.807Z" fill="#A5D38C" stroke="#96CD79" strokeWidth="0.8"/>
