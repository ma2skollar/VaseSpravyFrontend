...
const CoverageDetailContainer = (props: CoverageDetailContainerProps) => {
    return (
        <div className={styles.container}>
            <CoverageDetail type={CoverageDetailType.Distribution} title='Distribúcia politickej zaujatosti' onClick={() => {alert('Compass go BIIIIGGG!')}} text={`Zhrnutie politickej zaujatosti zdrojov pre udalosť ${props.eventName}. Otvor pre detaily a zobrazenie na politickom kompase.`} />
